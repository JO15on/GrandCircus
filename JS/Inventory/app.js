class Store {
    ...
    // Get an array of all the computer objects
    getComputers = _ => this.getProductByType(Computer);

    // Get an array of all the laptop objects
    getLaptops = _ => this.getProductByType(Laptop);
...
class Computer extends Product {
    constructor (name, price) { // constructor of the child
      super(name, price); // same as the parent, passes the variable from the constructor
      this.type = 'computer';
    }
}
...
store.addProduct(new Monitor('Alien Ware'), 30);
store2.inventory = [];
